...
**Table 15. Best control arm versus best deep arm on the caller-candidate
...
**Table 16. Coded evaluation design of the 18 retrievable papers in the audit
...
strict defect count in Table 16 is conservative: it credits a paper with the
