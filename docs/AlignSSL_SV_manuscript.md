...
| 1,673 (50%) | Classical-GBT | 0.982 ± 0.002 | AlignSSL-scratch | 0.953 ± 0.005 | -0.029 | 0.0337 | **control** |
...
and leads significantly at four of the five budgets measured.** It is worth
...
from reversing the withdrawal. It is one cell of a five-budget family, so we
...
*p* = 0.014, the only budget in the family to do so. It does not persist, and
past 10% labels it inverts: the from-scratch arm is marginally ahead at 25%
(0.933 versus 0.918, *p* = 0.268) and ahead at 50% by more than the
uncorrected test tolerates (0.953 ± 0.005 versus 0.922 ± 0.014, *p* = 0.029;
Holm *p* = 0.114, so not significant within the family). Whatever pretraining
