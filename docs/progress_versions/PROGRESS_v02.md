...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 0.0 | Index high-cov BAMs (had NO .bai — real blocker) | 🟡 | Job 1514611 running (samtools 1.9, hydra-n1); .bai → scratch/bam_idx/ |
| 0.1 | BAM→tensor pipeline built & cached | 🟡 | Code done (A9/A10) + `scripts/extract_tensors.py` written & tested; **extraction blocked on 0.0 (needs .bai)** |
