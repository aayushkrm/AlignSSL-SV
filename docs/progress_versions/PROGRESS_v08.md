...
_Last updated: 2026-07-14 (sweep complete). Maps to the Phase 0–5 plan in `project.md`._
...
| Label fraction | n(train) | Pretrained F1 | From-scratch F1 |
|---|---|---|---|
| **1%** | 128 | **0.400 ± 0.066** | **0.000 ± 0.000** |
| 5% | 383 | 0.408 ± 0.086 | 0.274 ± 0.188 |
| 10% | 767 | 0.563 ± 0.051 | 0.721 ± 0.065 |
| 25% | 1,918 | 0.677 ± 0.041 | 0.760 ± 0.065 |
| 50% | 3,836 | 0.747 ± 0.078 | 0.744 ± 0.046 |
| 100% | 7,672 | 0.803 ± 0.117 | 0.819 ± 0.036 |
...
4. **Phase 0.3 — DeepSV-like supervised baseline** on our split, for the head-to-head F1 claim. ← _next; this is what unblocks any "vs DeepSV" statement._
5. **Cross-population eval**: extract NA12878 (CEU) test tensors, score the fine-tuned model on a held-out individual + ancestry.
